...
#  end
 ...
 def is_admin?    
     if current_user_login && current_user_login.is_admin == "y"
       return true
     else
       return false
     end
 ...
 def deny_access
   store_location
   redirect_to new_user_login_session_path, :notice => "Please sign in to access this page."
 end
end
